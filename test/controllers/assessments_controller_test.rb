...
class AssessmentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create assessment" do
    assert_difference('Assessment.count') do
      post assessments_url, params: { assessment: { course_id: @assessment.course_id, name: @assessment.name, weight: @assessment.weight } }
    end
  ...
  test "should update assessment" do
    patch assessment_url(@assessment), params: { assessment: { course_id: @assessment.course_id, name: @assessment.name, weight: @assessment.weight } }
